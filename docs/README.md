...
You can try the VAST-IMA-Player by visiting the [test-page](http://unpkg.com/@glomex/vast-ima-player@1/test-page/index.html).
...
Or visit the [test-page](http://unpkg.com/@glomex/vast-ima-player@1/test-page/index.html).
